...
final class StackTrimmingFailedValidationExecutorTest {
    ...
    @Nested
    final class StackTrimmingFailedValidationExecutorTestContainer implements NoStackTraceValidationExecutorsContract<IllegalStateException> {
